...
\item Incorporating second-order information brings small improvements in
$\mathcal{E}$. When minimizing $\mathcal{E}$, all four algorithms are dominated
by the polynomial factor in $1/\epsilon$. The second-order methods only improve
the logarithmic factors in $1/\epsilon$.
